export default function (runtime) {
        ...
        switch (a.kind) {
            ...
            case runtime.INSTANCE_KIND_OPTION:
                if (a.name < b.name) {
                    ...
                    if (a.name === "Nar.Base.Array.Array#ArrayImpl" && b.name === "Nar.Base.Array.Array#ArrayImpl") {
                        return cmp(
                            runtime.execute("Nar.Base.Array.toList", a),
                            runtime.execute("Nar.Base.Array.toList", b)
                        )
                    }
    ...
    runtime.scope("Nar.Base", {cmpList});

    runtime.register("Nar.Base.Basics", {
    ...
    runtime.register("Nar.Base.Math", {
        add: (x, y) => {
            if (x.kind !== y.kind) {
                throw "types are not equal";
            }
    ...
    runtime.register("Nar.Base.Bitwise", {
    ...
    runtime.register("Nar.Base.Char", {
    ...
    runtime.register("Nar.Base.Debug", {
    ...
    runtime.register("Nar.Base.List", {  //TODO: optimize all list functions
        ...
        sortWith: (f, xs) => {
            ...
            l.sort((a, b) => {
                ...
                if (res.name === "Nar.Base.Basics.Order#LT") {
                    return -1;
                }
                if (res.name === "Nar.Base.Basics.Order#GT") {
                    return 1;
                }
                if (res.name === "Nar.Base.Basics.Order#EQ") {
                    return 0;
                }
                throw "expected Nar.Base.Basics.Order";
            });
    ...
    runtime.register("Nar.Base.String", {
        ...
        toInt: (n) => {
            const maybe = runtime.qualifierIdentifier("Nar.Base.Maybe", "Maybe");
    ...
    runtime.register("Nar.Base.NativeArray", {
